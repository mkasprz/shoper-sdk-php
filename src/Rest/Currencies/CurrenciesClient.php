...
namespace Shoper\Sdk\Rest\Currencies;

use Psr\Http\Client\ClientInterface;
use Shoper\Sdk\Rest\Core\Client\RawClient;
use Shoper\Sdk\Rest\Currencies\Requests\ListCurrenciesRequest;
use Shoper\Sdk\Rest\Currencies\Types\ListCurrenciesResponse;
...
class CurrenciesClient
{
    ...
    /**
     * @param ListCurrenciesRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
    ...
    public function list(ListCurrenciesRequest $request = new ListCurrenciesRequest(), ?array $options = null): ?ListCurrenciesResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListCurrenciesResponse::fromJson($json);
            }
