...
namespace Shoper\Sdk\Rest\AuctionHouses;

use Psr\Http\Client\ClientInterface;
use Shoper\Sdk\Rest\Core\Client\RawClient;
use Shoper\Sdk\Rest\AuctionHouses\Requests\ListAuctionHousesRequest;
use Shoper\Sdk\Rest\AuctionHouses\Types\ListAuctionHousesResponse;
...
use Shoper\Sdk\Rest\AuctionHouses\Requests\AuctionHouseInsert;
use Shoper\Sdk\Rest\Types\AuctionHouse;
use Shoper\Sdk\Rest\Core\Json\JsonDecoder;
use Shoper\Sdk\Rest\Core\Types\Union;
use Shoper\Sdk\Rest\AuctionHouses\Requests\AuctionHouseUpdate;

class AuctionHousesClient
{
    /**
     * @var array{
     *   baseUrl?: string,
    ...
    /**
     * @param ListAuctionHousesRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * } $options
     * @return ?ListAuctionHousesResponse
    ...
    public function listAuctionHouses(ListAuctionHousesRequest $request = new ListAuctionHousesRequest(), ?array $options = null): ?ListAuctionHousesResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListAuctionHousesResponse::fromJson($json);
            }
    ...
    /**
     * @param AuctionHouseInsert $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
    ...
    public function createAuctionHouse(AuctionHouseInsert $request, ?array $options = null): int|AuctionHouse|null
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return JsonDecoder::decodeUnion($json, new Union('integer', AuctionHouse::class)); // @phpstan-ignore-line
            }
        } catch (JsonException $e) {
            throw new ShoperException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
    ...
    public function getAuctionHouse(string $id, ?array $options = null): ?AuctionHouse
    {
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Default_->value,
                    path: "webapi/rest/auction-houses/{$id}",
                    method: HttpMethod::GET,
                ),
                $options,
            );
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return AuctionHouse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new ShoperException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     * @throws ShoperApiException
     */
    public function updateAuctionHouse(string $id, AuctionHouseUpdate $request = new AuctionHouseUpdate(), ?array $options = null): bool|AuctionHouse|null
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return JsonDecoder::decodeUnion($json, new Union('bool', AuctionHouse::class)); // @phpstan-ignore-line
            }
        } catch (JsonException $e) {
            throw new ShoperException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     * @throws ShoperApiException
     */
    public function deleteAuctionHouse(string $id, ?array $options = null): ?bool
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
