...
namespace Shoper\Sdk\Rest\Availabilities;

use Psr\Http\Client\ClientInterface;
use Shoper\Sdk\Rest\Core\Client\RawClient;
use Shoper\Sdk\Rest\Availabilities\Requests\ListAvailabilitiesRequest;
use Shoper\Sdk\Rest\Availabilities\Types\ListAvailabilitiesResponse;
...
class AvailabilitiesClient
{
    ...
    /**
     * @param ListAvailabilitiesRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
    ...
    public function list(ListAvailabilitiesRequest $request = new ListAvailabilitiesRequest(), ?array $options = null): ?ListAvailabilitiesResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListAvailabilitiesResponse::fromJson($json);
            }
