...
namespace Shoper\Sdk\Rest\AdditionalFields\Requests;

use Shoper\Sdk\Rest\Core\Json\JsonSerializableType;
use Shoper\Sdk\Rest\Core\Json\JsonProperty;
use Shoper\Sdk\Rest\AdditionalFields\Types\AdditionalFieldUpdateTranslationsValue;
use Shoper\Sdk\Rest\Core\Types\ArrayType;

class AdditionalFieldUpdate extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<string, AdditionalFieldUpdateTranslationsValue> $translations translations data
     */
    #[JsonProperty('translations'), ArrayType(['string' => AdditionalFieldUpdateTranslationsValue::class])]
     ...
     *   order?: ?int,
     *   req?: ?bool,
     *   translations?: ?array<string, AdditionalFieldUpdateTranslationsValue>,
     *   type?: ?int,
     * } $values
     */
