...
use Shoper\Sdk\Rest\AdditionalFields\Types\AdditionalFieldInsertTranslationsValue;
use Shoper\Sdk\Rest\Core\Types\ArrayType;

class AdditionalFieldInsert extends JsonSerializableType
{
    /**
    ...
    /**
     * @var array<string, AdditionalFieldInsertTranslationsValue> $translations translations data
     */
    #[JsonProperty('translations'), ArrayType(['string' => AdditionalFieldInsertTranslationsValue::class])]
     ...
     * @param array{
     *   locate: int,
     *   translations: array<string, AdditionalFieldInsertTranslationsValue>,
     *   type: int,
     *   active?: ?bool,
     *   checked?: ?bool,
     *   order?: ?int,
