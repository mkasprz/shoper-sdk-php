...
namespace Shoper\Sdk\Rest\AdditionalFields;

use Psr\Http\Client\ClientInterface;
use Shoper\Sdk\Rest\Core\Client\RawClient;
use Shoper\Sdk\Rest\AdditionalFields\Requests\ListAdditionalFieldsRequest;
use Shoper\Sdk\Rest\AdditionalFields\Types\ListAdditionalFieldsResponse;
...
use Shoper\Sdk\Rest\AdditionalFields\Requests\AdditionalFieldInsert;
use Shoper\Sdk\Rest\Types\AdditionalField;
use Shoper\Sdk\Rest\Core\Json\JsonDecoder;
use Shoper\Sdk\Rest\Core\Types\Union;
use Shoper\Sdk\Rest\AdditionalFields\Requests\AdditionalFieldUpdate;

class AdditionalFieldsClient
{
    /**
     * @var array{
     *   baseUrl?: string,
    ...
    /**
     * @param ListAdditionalFieldsRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * } $options
     * @return ?ListAdditionalFieldsResponse
    ...
    public function listAdditionalFields(ListAdditionalFieldsRequest $request = new ListAdditionalFieldsRequest(), ?array $options = null): ?ListAdditionalFieldsResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListAdditionalFieldsResponse::fromJson($json);
            }
    ...
    /**
     * @param AdditionalFieldInsert $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
    ...
    public function getAdditionalField(string $id, ?array $options = null): ?AdditionalField
    {
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Default_->value,
                    path: "webapi/rest/additional-fields/{$id}",
                    method: HttpMethod::GET,
                ),
                $options,
            );
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return AdditionalField::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new ShoperException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
