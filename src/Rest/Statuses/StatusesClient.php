...
namespace Shoper\Sdk\Rest\Statuses;

use Psr\Http\Client\ClientInterface;
use Shoper\Sdk\Rest\Core\Client\RawClient;
use Shoper\Sdk\Rest\Statuses\Requests\ListStatusesRequest;
use Shoper\Sdk\Rest\Statuses\Types\ListStatusesResponse;
...
use Shoper\Sdk\Rest\Types\Status;
...
class StatusesClient
{
    ...
    /**
     * @param ListStatusesRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
    ...
    public function list(ListStatusesRequest $request = new ListStatusesRequest(), ?array $options = null): ?ListStatusesResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListStatusesResponse::fromJson($json);
            }
