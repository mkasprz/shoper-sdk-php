...
namespace Shoper\Sdk\Rest\Gauges;

use Psr\Http\Client\ClientInterface;
use Shoper\Sdk\Rest\Core\Client\RawClient;
use Shoper\Sdk\Rest\Gauges\Requests\ListGaugesRequest;
use Shoper\Sdk\Rest\Gauges\Types\ListGaugesResponse;
...
class GaugesClient
{
    ...
    /**
     * @param ListGaugesRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
    ...
    public function listGauges(ListGaugesRequest $request = new ListGaugesRequest(), ?array $options = null): ?ListGaugesResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListGaugesResponse::fromJson($json);
            }
