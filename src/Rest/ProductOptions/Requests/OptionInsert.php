...
use Shoper\Sdk\Rest\ProductOptions\Types\OptionInsertTranslationsValue;
use Shoper\Sdk\Rest\Core\Types\ArrayType;

class OptionInsert extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<string, OptionInsertTranslationsValue> $translations an associative array with object translations
     */
    #[JsonProperty('translations'), ArrayType(['string' => OptionInsertTranslationsValue::class])]
     ...
     *   required?: ?bool,
     *   stock?: ?bool,
     *   translations?: ?array<string, OptionInsertTranslationsValue>,
     *   type?: ?string,
     * } $values
     */
