...
namespace Shoper\Sdk\Rest\Taxes;

use Psr\Http\Client\ClientInterface;
use Shoper\Sdk\Rest\Core\Client\RawClient;
use Shoper\Sdk\Rest\Taxes\Requests\ListTaxesRequest;
use Shoper\Sdk\Rest\Taxes\Types\ListTaxesResponse;
    ...
    public function listTaxes(ListTaxesRequest $request = new ListTaxesRequest(), ?array $options = null): ?ListTaxesResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListTaxesResponse::fromJson($json);
            }
