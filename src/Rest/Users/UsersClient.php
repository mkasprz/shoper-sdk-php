...
namespace Shoper\Sdk\Rest\Users;

use Psr\Http\Client\ClientInterface;
use Shoper\Sdk\Rest\Core\Client\RawClient;
use Shoper\Sdk\Rest\Users\Requests\ListUsersRequest;
use Shoper\Sdk\Rest\Users\Types\ListUsersResponse;
...
use Shoper\Sdk\Rest\Users\Requests\UserInsert;
use Shoper\Sdk\Rest\Types\User;
use Shoper\Sdk\Rest\Core\Json\JsonDecoder;
use Shoper\Sdk\Rest\Core\Types\Union;
use Shoper\Sdk\Rest\Users\Requests\UserUpdate;
...
class UsersClient
{
    ...
    public function listUsers(ListUsersRequest $request = new ListUsersRequest(), ?array $options = null): ?ListUsersResponse
    {
        ...
        if ($request->filtersFirstname != null) {
            $query['filters[firstname]'] = $request->filtersFirstname;
        }
        if ($request->filtersLastname != null) {
            $query['filters[lastname]'] = $request->filtersLastname;
        }
        if ($request->filtersEmail != null) {
            $query['filters[email]'] = $request->filtersEmail;
        }
        if ($request->filtersDiscount != null) {
            $query['filters[discount]'] = $request->filtersDiscount;
        }
        if ($request->filtersNewsletter != null) {
            $query['filters[newsletter]'] = $request->filtersNewsletter;
        }
        if ($request->filtersActive != null) {
            $query['filters[active]'] = $request->filtersActive;
        }
        if ($request->filtersLangId != null) {
            $query['filters[lang_id]'] = $request->filtersLangId;
        }
        if ($request->filtersGroupId != null) {
            $query['filters[group_id]'] = $request->filtersGroupId;
        }
