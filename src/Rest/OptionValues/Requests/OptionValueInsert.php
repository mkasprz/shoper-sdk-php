...
use Shoper\Sdk\Rest\OptionValues\Types\OptionValueInsertTranslationsValue;
use Shoper\Sdk\Rest\Core\Types\ArrayType;

class OptionValueInsert extends JsonSerializableType
{
    /**
     * <ul>
    ...
    /**
     * @var ?array<string, OptionValueInsertTranslationsValue> $translations an associative array with object translations
     */
    #[JsonProperty('translations'), ArrayType(['string' => OptionValueInsertTranslationsValue::class])]
     ...
     *   order?: ?int,
     *   percent?: ?int,
     *   translations?: ?array<string, OptionValueInsertTranslationsValue>,
     * } $values
     */
