 ...
 */
class ProductUpdateStock extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?ProductUpdateStockAdditionalCodes $additionalCodes additional codes
     */
    #[JsonProperty('additional_codes')]
    public ?ProductUpdateStockAdditionalCodes $additionalCodes;
     ...
     * @param array{
     *   active?: ?bool,
     *   additionalCodes?: ?ProductUpdateStockAdditionalCodes,
     *   availabilityId?: ?int,
