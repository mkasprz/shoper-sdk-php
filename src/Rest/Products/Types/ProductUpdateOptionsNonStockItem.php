...
class ProductUpdateOptionsNonStockItem extends JsonSerializableType
{
    /**
     ...
     * @var ?array<(
     *    int
     *   |ProductUpdateOptionsNonStockItemValuesItemActive
     * )> $values
     */
    #[JsonProperty('values'), ArrayType([new Union('integer', ProductUpdateOptionsNonStockItemValuesItemActive::class)])]
    public ?array $values;
