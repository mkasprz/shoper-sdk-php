...
namespace Shoper\Sdk\Rest\ApplicationLocks;

use Psr\Http\Client\ClientInterface;
use Shoper\Sdk\Rest\Core\Client\RawClient;
use Shoper\Sdk\Rest\Types\ApplicationLock;
...
use Shoper\Sdk\Rest\ApplicationLocks\Requests\ApplicationLockInsert;
use Shoper\Sdk\Rest\Core\Json\JsonDecoder;
use Shoper\Sdk\Rest\Core\Types\Union;
use Shoper\Sdk\Rest\ApplicationLocks\Requests\ApplicationLockUpdate;

class ApplicationLocksClient
{
    /**
     * @var array{
     *   baseUrl?: string,
    ...
    public function get(?array $options = null): ?ApplicationLock
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ApplicationLock::fromJson($json);
            }
    ...
    /**
     * @param ApplicationLockInsert $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
    ...
    /**
     * @param ApplicationLockUpdate $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
