...
namespace Shoper\Sdk\Rest\OrderTags;

use Psr\Http\Client\ClientInterface;
use Shoper\Sdk\Rest\Core\Client\RawClient;
use Shoper\Sdk\Rest\OrderTags\Requests\ListOrderTagsRequest;
use Shoper\Sdk\Rest\OrderTags\Types\ListOrderTagsResponse;
...
use Shoper\Sdk\Rest\OrderTags\Requests\OrderTagInsert;
use Shoper\Sdk\Rest\Types\OrderTag;
use Shoper\Sdk\Rest\Core\Json\JsonDecoder;
use Shoper\Sdk\Rest\Core\Types\Union;
use Shoper\Sdk\Rest\OrderTags\Requests\OrderTagUpdate;

class OrderTagsClient
{
    /**
     * @var array{
     *   baseUrl?: string,
    ...
    /**
     * @param ListOrderTagsRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
    ...
    public function listOrderTags(ListOrderTagsRequest $request = new ListOrderTagsRequest(), ?array $options = null): ?ListOrderTagsResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListOrderTagsResponse::fromJson($json);
            }
    ...
    public function getOrderTag(string $id, ?array $options = null): ?OrderTag
    {
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Default_->value,
                    path: "webapi/rest/order-tags/{$id}",
                    method: HttpMethod::GET,
                ),
                $options,
            );
