...
use Shoper\Sdk\Rest\Payments\Types\PaymentUpdateTranslationsValue;

class PaymentUpdate extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<string, PaymentUpdateTranslationsValue> $translations an associative array with object translations
     */
    #[JsonProperty('translations'), ArrayType(['string' => PaymentUpdateTranslationsValue::class])]
     ...
     *   translations?: ?array<string, PaymentUpdateTranslationsValue>,
     * } $values
     */
