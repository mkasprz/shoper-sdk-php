...
class PaymentChannelTranslationsValue extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<PaymentChannelTranslationsValueActive> $active is the channel active for this locale
     */
    #[JsonProperty('active')]
     ...
     *   imageUrl?: ?string,
     *   active?: ?value-of<PaymentChannelTranslationsValueActive>,
     * } $values
     */
