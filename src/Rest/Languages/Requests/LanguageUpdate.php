...
use Shoper\Sdk\Rest\Languages\Types\LanguageUpdateActive;
use Shoper\Sdk\Rest\Core\Json\JsonProperty;

class LanguageUpdate extends JsonSerializableType
{
    /**
     * @var ?value-of<LanguageUpdateActive> $active is language active
     */
    #[JsonProperty('active')]
    ...
    /**
     * @param array{
     *   active?: ?value-of<LanguageUpdateActive>,
     *   currencyId?: ?string,
     *   locale?: ?string,
     *   order?: ?string,
     * } $values
