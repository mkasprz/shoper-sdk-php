...
namespace Shoper\Sdk\Rest\News;

use Psr\Http\Client\ClientInterface;
use Shoper\Sdk\Rest\Core\Client\RawClient;
use Shoper\Sdk\Rest\News\Requests\ListNewsRequest;
use Shoper\Sdk\Rest\News\Types\ListNewsResponse;
...
use Shoper\Sdk\Rest\News\Requests\NewsInsert;
use Shoper\Sdk\Rest\Types\News;
use Shoper\Sdk\Rest\Core\Json\JsonDecoder;
use Shoper\Sdk\Rest\Core\Types\Union;
use Shoper\Sdk\Rest\News\Requests\NewsUpdate;
    ...
    public function listNews(ListNewsRequest $request = new ListNewsRequest(), ?array $options = null): ?ListNewsResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListNewsResponse::fromJson($json);
            }
