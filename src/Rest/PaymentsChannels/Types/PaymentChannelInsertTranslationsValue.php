...
class PaymentChannelInsertTranslationsValue extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<PaymentChannelInsertTranslationsValueActive> $active is the channel active for this locale
     */
    #[JsonProperty('active')]
     ...
     *   imageUrl?: ?string,
     *   active?: ?value-of<PaymentChannelInsertTranslationsValueActive>,
     * } $values
     */
