...
use Shoper\Sdk\Rest\PromotionCodes\Types\PromotionCodeUpdateRangesItem;

class PromotionCodeUpdate extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<PromotionCodeUpdateRangesItem> $ranges an array of progressive discount ranges
     */
    #[JsonProperty('ranges'), ArrayType([PromotionCodeUpdateRangesItem::class])]
    public ?array $ranges;
     ...
     *   ranges?: ?array<PromotionCodeUpdateRangesItem>,
     *   shippings?: ?array<int>,
     *   timeFrom?: ?string,
     *   timeTo?: ?string,
     *   usageCount?: ?int,
