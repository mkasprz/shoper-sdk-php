...
class OrderProductInsertChildrenItem extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<OrderProductInsertChildrenItemFileOptionsItem> $fileOptions
     */
    #[JsonProperty('file_options'), ArrayType([OrderProductInsertChildrenItemFileOptionsItem::class])]
     ...
     * (only for products with stocks)
     *
     * @var ?array<OrderProductInsertChildrenItemTextOptionsItem> $textOptions
     */
    #[JsonProperty('text_options'), ArrayType([OrderProductInsertChildrenItemTextOptionsItem::class])]
     ...
     *   deliveryTime?: ?float,
     *   discountPerc?: ?float,
     *   fileOptions?: ?array<OrderProductInsertChildrenItemFileOptionsItem>,
     *   id?: ?int,
     *   name?: ?string,
     *   option?: ?string,
     *   orderId?: ?int,
