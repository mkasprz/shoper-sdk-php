...
/**
 * stats of last 7 dats
 */
class DashboardStat7Days extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?int $returningCustomers unique returning customers count from orders in last 7 days
     */
    ...
    /**
     * @var ?int $uniqueCustomers unique customers count from orders in last 7 days
     */
