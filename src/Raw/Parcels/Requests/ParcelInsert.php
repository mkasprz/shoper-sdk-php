...
use Shoper\Sdk\Rest\Parcels\Types\ParcelInsertProductsItem;
use Shoper\Sdk\Rest\Core\Types\ArrayType;

class ParcelInsert extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<ParcelInsertProductsItem> $products an  array with products
     */
    #[JsonProperty('products'), ArrayType([ParcelInsertProductsItem::class])]
     ...
     *   orderDate?: ?string,
     *   orderId?: ?int,
     *   products?: ?array<ParcelInsertProductsItem>,
     *   send?: ?bool,
     *   shippingCode?: ?string,
     *   warehouseId?: ?int,
     *   weight?: ?float,
