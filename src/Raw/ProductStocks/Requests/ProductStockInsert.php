...
use Shoper\Sdk\Rest\ProductStocks\Types\ProductStockInsertAdditionalCodes;
use Shoper\Sdk\Rest\ProductStocks\Types\ProductStockInsertOptionsItem;
use Shoper\Sdk\Rest\Core\Types\ArrayType;

class ProductStockInsert extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?ProductStockInsertAdditionalCodes $additionalCodes additional codes
     */
    #[JsonProperty('additional_codes')]
    public ?ProductStockInsertAdditionalCodes $additionalCodes;
    ...
    /**
     * @var ?array<ProductStockInsertOptionsItem> $options an array of stock options
     */
    #[JsonProperty('options'), ArrayType([ProductStockInsertOptionsItem::class])]
     ...
     * @param array{
     *   active?: ?bool,
     *   additionalCodes?: ?ProductStockInsertAdditionalCodes,
     *   availabilityId?: ?int,
     ...
     *   options?: ?array<ProductStockInsertOptionsItem>,
     *   package?: ?float,
     *   price?: ?float,
     *   priceBuying?: ?float,
     *   priceSpecial?: ?float,
