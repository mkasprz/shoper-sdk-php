...
namespace Shoper\Sdk\Rest\Redirects;

use Psr\Http\Client\ClientInterface;
use Shoper\Sdk\Rest\Core\Client\RawClient;
use Shoper\Sdk\Rest\Redirects\Requests\ListRedirectsRequest;
use Shoper\Sdk\Rest\Redirects\Types\ListRedirectsResponse;
...
class RedirectsClient
{
    ...
    /**
     * @param ListRedirectsRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
    ...
    public function listRedirects(ListRedirectsRequest $request = new ListRedirectsRequest(), ?array $options = null): ?ListRedirectsResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListRedirectsResponse::fromJson($json);
            }
