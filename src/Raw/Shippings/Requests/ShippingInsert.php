...
use Shoper\Sdk\Rest\Shippings\Types\ShippingInsertRangesItem;
use Shoper\Sdk\Rest\Shippings\Types\ShippingInsertTranslationsValue;

class ShippingInsert extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<ShippingInsertRangesItem> $ranges an array of weight/price ranges
     */
    #[JsonProperty('ranges'), ArrayType([ShippingInsertRangesItem::class])]
    public ?array $ranges;
    ...
    /**
     * @var ?array<string, ShippingInsertTranslationsValue> $translations an associative array with object translations
     */
    #[JsonProperty('translations'), ArrayType(['string' => ShippingInsertTranslationsValue::class])]
     ...
     *   order?: ?float,
     *   pkwiu?: ?float,
     *   ranges?: ?array<ShippingInsertRangesItem>,
     *   translations?: ?array<string, ShippingInsertTranslationsValue>,
     *   url?: ?string,
