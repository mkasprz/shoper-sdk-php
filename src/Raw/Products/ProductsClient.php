...
use Shoper\Sdk\Rest\Types\Product;
...
class ProductsClient
{
    ...
    public function listProducts(ListProductsRequest $request = new ListProductsRequest(), ?array $options = null): ?ListProductsResponse
    {
        ...
        if ($request->filtersCategoryTreeId != null) {
            $query['filters[category_tree_id]'] = $request->filtersCategoryTreeId;
        }
        if ($request->filtersBestseller != null) {
            $query['filters[bestseller]'] = $request->filtersBestseller;
        }
        ...
        if ($request->filtersCollections != null) {
            $query['filters[collections]'] = $request->filtersCollections;
        }
        try {
     ...
     * @throws ShoperApiException
     */
    public function updateProduct(string $id, ProductUpdate $request = new ProductUpdate(), ?array $options = null): int|Product|null
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws ShoperApiException
     */
    public function deleteProduct(string $id, ?array $options = null): ?int
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
