...
class ProductInsert extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?ProductInsertSafetyInformation $safetyInformation product safety information
     */
    #[JsonProperty('safety_information')]
    public ?ProductInsertSafetyInformation $safetyInformation;

    /**
     * @var ?ProductInsertSpecialOffer $specialOffer **Deprecated since 5.24.35.** an associative array with product general special offer information (applies for product itself and all variants that do not have dedicated special offer)
     */
    #[JsonProperty('special_offer')]
    public ?ProductInsertSpecialOffer $specialOffer;

    /**
     * @var ProductInsertStock $stock an associative array with base stock info
     */
    #[JsonProperty('stock')]
    public ProductInsertStock $stock;
    ...
    /**
     * @var array<string, ProductInsertTranslationsValue> $translations an associative array with object translations; if you want to filter things - you can skip locale subkey
     */
    #[JsonProperty('translations'), ArrayType(['string' => ProductInsertTranslationsValue::class])]
     ...
     *   specialOffer?: ?ProductInsertSpecialOffer,
     *   tagId?: ?int,
     *   tags?: ?array<int>,
     *   unitId?: ?int,
