...
namespace Shoper\Sdk\Rest\Zones;

use Psr\Http\Client\ClientInterface;
use Shoper\Sdk\Rest\Core\Client\RawClient;
use Shoper\Sdk\Rest\Zones\Requests\ListZonesRequest;
use Shoper\Sdk\Rest\Zones\Types\ListZonesResponse;
    ...
    public function listZones(ListZonesRequest $request = new ListZonesRequest(), ?array $options = null): ?ListZonesResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListZonesResponse::fromJson($json);
            }
