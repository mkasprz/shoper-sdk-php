...
namespace Shoper\Sdk\Rest\Languages;

use Psr\Http\Client\ClientInterface;
use Shoper\Sdk\Rest\Core\Client\RawClient;
use Shoper\Sdk\Rest\Languages\Requests\ListLanguagesRequest;
use Shoper\Sdk\Rest\Languages\Types\ListLanguagesResponse;
...
class LanguagesClient
{
    ...
    /**
     * @param ListLanguagesRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
    ...
    public function listLanguages(ListLanguagesRequest $request = new ListLanguagesRequest(), ?array $options = null): ?ListLanguagesResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListLanguagesResponse::fromJson($json);
            }
